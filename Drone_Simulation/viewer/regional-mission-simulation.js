...
export class RegionalMissionSimulation{
  constructor(plan,{onCapture=()=>{},onEvent=()=>{}}={}){this.plan=plan;this.options=plan.options;this.onCapture=onCapture;this.onEvent=onEvent;this.reset();}
  ...
  get multiplier(){return this.paused?0:['survey','inspection','search','found'].includes(this.phase)?70:this.phase==='outbound'?50:10;}
