...
export const operationsTables = {
  ...
  operatorProfiles: defineTable({ userId: v.id("users"), approved: v.boolean(), acceptingJobs: v.boolean(), qualifications: v.array(jobKind), base: geo, serviceRadiusM: v.number(), presetLocations: v.optional(v.array(presetLocation)), activeOperationId: v.optional(v.id("operations")) }).index("by_user", ["userId"]),
