...
export function OperatorSplit({ board, map, overlay = false, storageKey = STORAGE_KEY }: { board: ReactNode; map: ReactNode; overlay?: boolean; storageKey?: string }) {
  ...
  return (
    <div
      ...
      style={overlay ? undefined : { ["--split" as string]: `${split}%` }}
    >
